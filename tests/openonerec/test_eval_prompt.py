...
def _load_eval_module():
    module_path = Path(__file__).resolve().parents[2] / "eval" / "openonerec_eval.py"
...
def test_prepare_eval_prompt_messages_removes_labeled_answer():
    ...
    assert groundtruth == "<|sid_begin|>target<|sid_end|>"
